...
function updateChatHeader() {
    ...
    chatHeader.innerHTML = `
        <div class="chat-user-avatar" style="background-color: ${currentChatUser.color}">
    ...
    messages.forEach(msg => {
        ...
        container.innerHTML += `
            <div class="message ${messageClass}">
                <div class="message-avatar" style="background-color: ${avatarColor}">${avatar}</div>
